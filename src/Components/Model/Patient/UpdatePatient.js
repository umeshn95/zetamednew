...
import { patientAction, PatienSingleAction } from "../../../Actions/PatientAction";
...
const UpdatePatient = ({ updatePatientCheck, setUpdatePatientCheck, id, setRunAction }) => {
    ...
    }, [dispatch, loading, patientGroup, patientSingle, id, patient])
